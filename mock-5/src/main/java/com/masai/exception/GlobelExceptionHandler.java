...
public class GlobelExceptionHandler {
		...
		public ResponseEntity<MyErrorDetails> exceptionHandler(BookException ae, WebRequest req){
		...
		public ResponseEntity<MyErrorDetails> exceptionHandler(AdminException ae, WebRequest req){
